...
> SearchEngine API: Full-text and vector search with faceting and relevance tuning
...
## 🧰 Tech Stack
C++, REST API, PostgreSQL, CMake

## 🏗️ Architecture
Three-tier architecture: C++, REST API backend, native frontend, PostgreSQL database. Containerized with Docker.
...
git clone https://github.com/elitsuri/searchengine-api
cd searchengine-api
